      ...
      <div class='relative m-0 shadow-lg flex'>
        ...
        <div class="h-4 mb-3 bg-263159 "> </div>
          <div class="w-100 pt-10 p-12">
            <p class="text-3xl font-bold color-E22637 ml-3 text-center ">Log in as GUEST</p>
            <p class="text-md ml-3 font-bold text-grey text-center block mt-6 mb-10 color-263159">leave a comment and give your Virtual Money to your favorite Projects!</p>
           ...
           <div className="mb-2">
              <label className="text-xl flex justify-center font-bold color-263159">Username</label>
            ...
            <div class="flex justify-center"><input class="button-lightpink h-10 text-lg " type="submit" value="Submit" ></input></div>
           
          </div>
        </form>

        </div><div class="h-8 bg-263159"> </div></div></div>
      </div></div>
